...
export default defineConfig({
  plugins: [
    ...
    SvelteKitPWA({
      ...
      manifest: {
        name: 'Cheers! — Inglés de supervivencia para el Reino Unido',
        short_name: 'Cheers!',
        description: 'Inglés británico + cultura para el Reino Unido · prioridad al audio, funciona sin conexión',
        lang: 'es',
        theme_color: '#C84B31',
